...
from phiegg.phillm.card import PHILLM_CARD
from phiegg.phillm.open_ai_model import OpenAiModelClient
from phiegg.phillm.verbs import PhiLLMVerb
...
class PhiLLMAgent(PhiAgent):
    ...
    def __init__(self, data_resolver=None) -> None:
        ...
        from phiegg._core.auth import TokenAuth
