...
from phiegg._core.agent_card import AgentCard, AgentLayer, PhiSpec, PhiTask, PhiVerb
from phiegg._core.topology import Morphism, Node, Space, Traversal
...
class PhiAgent(ABC):
    """Universal base for ALL PhiEgg domain agents.
    ...
    def __init__(self, data_resolver=None, version: Optional[str] = None) -> None:
        ...
        if data_resolver is None:
            try:
                ...
                from phiegg.phiora.store import ResolverClient, StoreClient
