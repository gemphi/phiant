...
| File | Purpose |
| :--- | :--- |
| [`agent.py`](./phient/src/phiegg/phical/agent.py) | `PhiCalAgent` 4-phase universal recursive lifecycle. |
| [`circuit.py`](./phient/src/phiegg/phical/circuit.py) | `CircuitClient` for unitary quantum gate transformations. |
| [`semantic_search.py`](./phient/src/phiegg/phical/semantic_search.py) | `SemanticSearchClient` for superposition document search. |
| [`training.py`](./phient/src/phiegg/phical/training.py) | `TrainingClient` for gradient descent parameter training. |
| [`models.py`](./phient/src/phiegg/phical/models.py) | Mathematical dataclasses (`QubitState`, `QuantumCircuitModel`). |
| [`spec.md`](./phient/src/phiegg/phical/spec.md) | Formal specification contract. |
| [`uses.md`](./phient/src/phiegg/phical/uses.md) | Copy-pasteable Python code examples. |
| [`topo.md`](./phient/src/phiegg/phical/topo.md) | Ontologylogical manifold specification. |
| [`topo/topology.mdx`](./phient/src/phiegg/phical/topo/topology.mdx) | MDX live diagram topology document. |
