...
from phiegg._core.topology import Fiber, Traversal
from phiegg.phical.models import SemanticResult, SemanticSpace
...
class SemanticSearchClient:
    ...
    async def fiber_search(
        ...
        *,
        ...
        """
        from phiegg._core.topology import Morphism
