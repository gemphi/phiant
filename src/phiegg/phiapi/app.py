...
def create_app() -> FastAPI:
    ...
    async def get_dashboard():
        ...
        return HTMLResponse(content="<h1>PhiEgg AIP Dashboard</h1>")
    ...
    async def generate_new_agent(req: AgentGenerateRequest):
        from phiegg.phicli.scaffold import scaffold_agent
        res = scaffold_agent(
    ...
    async def get_ontologies_schema():
        from phiegg.ontologies.engine import GLOBAL_ONTOLOGY
    ...
    async def get_docs_catalog():
        ...
        catalog = [
            ...
            },
            {
                ...
                "items": [
                    {"id": "agent_phione", "title": "PhiOne: Identity & Workforce", "path": "src/phiegg/phione/README.md", "badge": "HR/Entra"},
                    {"id": "agent_phical", "title": "PhiCal: Quantum & Manifolds", "path": "src/phiegg/phical/README.md", "badge": "Quantum"},
                    {"id": "agent_phirag", "title": "PhiRAG: Knowledge Retrieval", "path": "src/phiegg/phirag/README.md", "badge": "RAG"},
                    {"id": "agent_phidoc", "title": "PhiDoc: Docs & Ontologylogies", "path": "src/phiegg/phidoc/README.md", "badge": "Docs"},
                    {"id": "agent_phibot", "title": "PhiBot: DAG Automations", "path": "src/phiegg/phibot/README.md", "badge": "DAG"},
                    {"id": "agent_phibrd", "title": "PhiBrd: Fiber Bundle Onboarding", "path": "src/phiegg/phibrd/README.md", "badge": "Fiber"},
                    {"id": "agent_phiora", "title": "PhiOra: Content-Addressed Storage", "path": "src/phiegg/phiora/README.md", "badge": "Data"},
                    {"id": "agent_phigit", "title": "PhiGit: Cryptographic DAG Engine", "path": "src/phiegg/phigit/README.md", "badge": "Git"},
                    {"id": "agent_philog", "title": "PhiLog: Telemetry & Auditing", "path": "src/phiegg/philog/README.md", "badge": "Logs"},
                    {"id": "agent_phillm", "title": "PhiLLM: Multi-Provider Gateway", "path": "src/phiegg/phillm/README.md", "badge": "LLM"},
                    {"id": "agent_phisec", "title": "PhiSec: Security & Vulnerabilities", "path": "src/phiegg/phisec/README.md", "badge": "Sec"},
                    {"id": "agent_phigov", "title": "PhiGov: Enterprise Governance", "path": "src/phiegg/phigov/README.md", "badge": "Gov"},
                    {"id": "agent_phibus", "title": "PhiBus: Event Bus Pub/Sub", "path": "src/phiegg/phibus/README.md", "badge": "Bus"},
                    {"id": "agent_phimen", "title": "PhiMen: Virtual CEO Orchestrator", "path": "src/phiegg/phimen/README.md", "badge": "CEO"},
                    {"id": "agent_phigen", "title": "PhiGen: Code Synthesis & Parity", "path": "src/phiegg/phigen/README.md", "badge": "Gen"},
                ]
            },
            {
                "category": "Query Paradigms & Quantum Computing",
                "items": [
                    {"id": "query_overview", "title": "Multi-Model Query Paradigms", "path": "src/phiegg/query/README.md", "badge": "Engines"},
                    {"id": "query_qml", "title": "Quantum Model Language (QML)", "path": "docs/v2/SqlQueries/QML.md", "badge": "QML"},
                    {"id": "query_spec", "title": "Query Formal Specification", "path": "src/phiegg/query/spec.md", "badge": "Spec"},
                    {"id": "query_uses", "title": "Query Code Examples", "path": "src/phiegg/query/uses.md", "badge": "Code"},
                ]
            },
            {
                "category": "Agent Code Examples (uses.md)",
                "items": [
                    {"id": "uses_phione", "title": "PhiOne Examples (uses.md)", "path": "src/phiegg/phione/uses.md", "badge": "Code"},
                    {"id": "uses_phical", "title": "PhiCal Examples (uses.md)", "path": "src/phiegg/phical/uses.md", "badge": "Code"},
                    {"id": "uses_phirag", "title": "PhiRAG Examples (uses.md)", "path": "src/phiegg/phirag/uses.md", "badge": "Code"},
                    {"id": "uses_phidoc", "title": "PhiDoc Examples (uses.md)", "path": "src/phiegg/phidoc/uses.md", "badge": "Code"},
                    {"id": "uses_phibot", "title": "PhiBot Examples (uses.md)", "path": "src/phiegg/phibot/uses.md", "badge": "Code"},
                    {"id": "uses_phibrd", "title": "PhiBrd Examples (uses.md)", "path": "src/phiegg/phibrd/uses.md", "badge": "Code"},
                    {"id": "uses_phiora", "title": "PhiOra Examples (uses.md)", "path": "src/phiegg/phiora/uses.md", "badge": "Code"},
                    {"id": "uses_phigit", "title": "PhiGit Examples (uses.md)", "path": "src/phiegg/phigit/uses.md", "badge": "Code"},
                    {"id": "uses_philog", "title": "PhiLog Examples (uses.md)", "path": "src/phiegg/philog/uses.md", "badge": "Code"},
                    {"id": "uses_phillm", "title": "PhiLLM Examples (uses.md)", "path": "src/phiegg/phillm/uses.md", "badge": "Code"},
                    {"id": "uses_phisec", "title": "PhiSec Examples (uses.md)", "path": "src/phiegg/phisec/uses.md", "badge": "Code"},
                    {"id": "uses_phigov", "title": "PhiGov Examples (uses.md)", "path": "src/phiegg/phigov/uses.md", "badge": "Code"},
                    {"id": "uses_phibus", "title": "PhiBus Examples (uses.md)", "path": "src/phiegg/phibus/uses.md", "badge": "Code"},
                    {"id": "uses_phimen", "title": "PhiMen Examples (uses.md)", "path": "src/phiegg/phimen/uses.md", "badge": "Code"},
                    {"id": "uses_phigen", "title": "PhiGen Examples (uses.md)", "path": "src/phiegg/phigen/uses.md", "badge": "Code"},
                ]
            },
            {
